...
function Payment() {
  ...
  // Whenever the basket changes it will make this request and it will update the special stripe secret which allows us to charge the customer correct amount.
  useEffect(() => {
